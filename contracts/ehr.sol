...
contract ehr {
  ...
  function treatPatient(address doctor,address patient) public{
  ...
  function viewAppointments() public view returns(address[] memory, address[] memory,string[] memory,bool[] memory) {
    return (_cdoctors,_cpatients,_cdates,_cstatus);
  }
